...
# _C.MODEL.SWIN2 = CN()
# _C.MODEL.SWIN2.PATCH_SIZE = 4
# _C.MODEL.SWIN2.IN_CHANS = 3
# _C.MODEL.SWIN2.EMBED_DIM = 96
# _C.MODEL.SWIN2.DEPTHS = [2, 2, 4, 2]
# _C.MODEL.SWIN2.NUM_HEADS = [3, 6, 12, 24]
# _C.MODEL.SWIN2.QUERY_HEAD_DIMS = [32, 32, 32, 32]
# _C.MODEL.SWIN2.VALUE_HEAD_DIMS = [16, 16, 16, 16]
# _C.MODEL.SWIN2.WINDOW_SIZE = 7
# _C.MODEL.SWIN2.MLP_RATIO = 2.
# _C.MODEL.SWIN2.QKV_BIAS = True
# _C.MODEL.SWIN2.QK_SCALE = None
...
# ScaledAdam
_C.TRAIN.OPTIMIZER.PARAM_MAX_RMS = 3.0
_C.TRAIN.OPTIMIZER.PARAM_MIN_RMS = 1.0e-5
